...
public class HomePage {
	...
	public static By questionmarkLoc=By.xpath("//a[contains(@href,'../help.html')]");
	...
	public static void questionmark(WebDriver driver)
	{
		driver.findElement(questionmarkLoc).click();
	}
}

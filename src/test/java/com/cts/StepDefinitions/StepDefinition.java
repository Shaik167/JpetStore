...
public class StepDefinition {
	...
	public void user_click_on_fish() {
		HomePage.clickOnFish(driver);
		
	   
	}

	@When("select product and fillany check in shopping cart")
	public void select_product_and_fillany_check_in_shopping_cart() {
		HomePage.clickOnFish(driver);
		FishPage.ClickOnKoi(driver);
		AddToCartPage.clickOnAddToCart(driver);
		CheckOutPage.clickOnProceedtoCheckout(driver);
		ContinueAndConfirmPage.clickOnContinue(driver);
		ContinueAndConfirmPage.clickOnShoppingcart(driver);
